...
client.user.setGame(`quran alkream`,"")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on('message', message =>  {
        ...
        if (!message.member.voiceChannel) return message.channel.send('**I\'m sorry but you need to be in a voice channel**');
